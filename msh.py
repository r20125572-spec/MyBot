...
CHANNEL_LINK           = "https://t.me/+ULJvulqKn-8wNzVl"
...
async def send_hit_log_to_group(
    ...
    hit_log_kb = InlineKeyboardMarkup(inline_keyboard=[[
        InlineKeyboardButton(text="𝘾𝘼𝙍𝘿 ✘ 𝘾𝙃𝙆", url="https://t.me/CARDCXC_BOT"),
    ]])
    try:
...
def get_result_buttons(session_id: str, is_running: bool = True) -> InlineKeyboardMarkup:
    """Returns an InlineKeyboardMarkup for the progress / result message."""
    session = MSH_SESSIONS.get(session_id, {})
